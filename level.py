        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_RIGHT:
                    a = [load_image("skeleton-move_0.png"),
                         load_image("skeleton-move_1.png"),
                         load_image("skeleton-move_2.png"),
                         load_image("skeleton-move_3.png"),
                         load_image("skeleton-move_4.png"),
                         load_image("skeleton-move_5.png"),
                         load_image("skeleton-move_6.png"),
                         load_image("skeleton-move_7.png"),
                         load_image("skeleton-move_8.png"),
                         load_image("skeleton-move_9.png"),
                         load_image("skeleton-move_10.png"),
                         load_image("skeleton-move_11.png"),
                         load_image("skeleton-move_12.png"),
                         load_image("skeleton-move_13.png"),
                         load_image("skeleton-move_14.png"),
                         load_image("skeleton-move_15.png"),
                         load_image("skeleton-move_16.png")]
                    dragon = AnimatedSprite(load_image("skeleton-move_0.png"), 50, 50, a)
                    dragon.rect.x += STEP
